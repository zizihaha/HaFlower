  ...
  <div class="loginPage">
    <div class="login">
      <form class="form form-signin" @submit.prevent="signin">
        ...
        <router-link class="text-center text-white d-block mt-5" to="/">
          <i class="fas fa-home"> HA.Flower</i>
        </router-link>
      </form>
    </div>
  </div>
...
.loginPage {
  background-image: url(https://images.unsplash.com/photo-1598188306155-25e400eb5078?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1267&q=80);
